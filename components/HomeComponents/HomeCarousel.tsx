          ...
          <CarouselItem key={index}>
            <div className="px-1 flex flex-col bg-[#DAE5DA]  h-96 justify-center items-center relative z-10 rounded-lg mb-4">
                <article className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                    <section className="flex flex-col items-center md:items-start justify-center pl-10">
                        <h1 className="uppercase font-bold text-green-1 lg:mb-4 text-sm">Welcome To Cooba</h1>
                        <p className="text-base sm:text-lg md:text-xl lg:text-3xl font-semibold mb-3">Fresh Ingredients Delivered to Your Doorstep</p>
